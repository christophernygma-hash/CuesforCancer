    ...
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl text-charcoal mb-2">Donor Portal</h1>
          <p className="text-charcoal-light">Sign in to manage your giving</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl">
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <p className="text-sm text-charcoal-light">
              ...
              <Link to="/donate" className="text-plum hover:underline">Make a donation to create one</Link>
            </p>
          </div>
        </div>
