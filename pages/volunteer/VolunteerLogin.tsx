    ...
    <div className="min-h-screen bg-cream flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <img src="/images/logo-transparent.png" alt="Cues for Cancer" className="h-16 mx-auto mb-4" />
          <h1 className="font-display text-3xl text-charcoal mb-2">Volunteer Portal</h1>
          <p className="text-charcoal-light">Sign in to manage your volunteer activities</p>
        </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="submit" disabled={isLoading} className="w-full btn-primary py-4 disabled:opacity-50">
              {isLoading ? 'Signing in...' : 'Sign In'}
            </button>
          </form>

          <div className="mt-6 text-center space-y-2">
            <a href="#" className="text-sm text-plum hover:underline">Forgot password?</a>
            <p className="text-sm text-charcoal-light">
              New volunteer?{' '}
              <Link to="/contact" className="text-plum hover:underline">Apply to volunteer</Link>
            </p>
          </div>
        </div>

        <div className="mt-8 text-center">
          <Link to="/" className="text-charcoal-light hover:text-plum transition-colors text-sm">
            ← Back to website
          </Link>
        </div>
      </div>
